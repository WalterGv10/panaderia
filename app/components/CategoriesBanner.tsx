        ...
        <section className="py-12 lg:py-24 border-y border-white/10 bg-black/20 backdrop-blur-md">
            <div className="max-w-7xl mx-auto px-4 overflow-hidden">
                <div className="flex gap-12 sm:gap-20 animate-infinite-scroll">
                    ...
                    {categories.map((cat, i) => (
                        <span key={`clone-${i}`} className="text-3xl sm:text-6xl font-black text-white/10 hover:text-brand-gold/60 transition-colors italic whitespace-nowrap cursor-default uppercase">
                            {cat}
                        </span>
                    ))}
                </div>
